package com.alberto.studycompanion.onboarding.presentation.components
        ...
        Box(modifier = modifier.background(color = Color.White)){
            HorizontalPager(count = pages.size, state = pagerState) {index ->
                    ...
                    horizontalAlignment = Alignment.CenterHorizontally)
                {
                    ...
                    Image(
                        ...
                        contentDescription = "onboarding screen image",
                ...
                horizontalArrangement = Arrangement.SpaceBetween)
            {
                if (pagerState.currentPage == pages.lastIndex) {
                    StudyButton(content = "Get Started", modifier = Modifier.fillMaxWidth()) {
                        onFinish()
                    }
                } else {
